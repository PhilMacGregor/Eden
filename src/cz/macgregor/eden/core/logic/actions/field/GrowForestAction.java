...
public class GrowForestAction implements FieldAction {
	...
	private static final TileType[] FORBIDDEN_TYPES = new TileType[] { TileType.WATER, TileType.DESERT, TileType.ORIGIN,
			TileType.MOUNTAINS };
	/**
	 * if one of those entities is present at a field, the treec can not be
	 * generated there.
	 */
	private static final EntityType[] OBSTACLES = new EntityType[] { EntityType.ADAM, EntityType.EVE,
			EntityType.BUILDING };
