...
public enum TileType {
  // name, image, is water, can build on, fertility, wood, stone, ore, danger
	...
	/** The holy tree. This tile is only generated at 0;0. It cannot be used by map generator. */
	 ...
	 * @param usedInGenerator if false, this tile type is not used in random generation by map generator
	 */
	...
	/**
	 * add to the list of usable items holded by a special object to prevent initialisation errors.
	 * @param type type
	 */
	...
	/**
	 * class to hold an instance of the List to store TileType instances used for random generation.
	 * @author MacGregor
	 *
	 */
