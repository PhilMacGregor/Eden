...
public final class Const {
	...
	/**
	 * maximum entities to be displayed on single field and position. If higher
	 * counts of entities are present, display them using a number instead.
	 */
	public static final int ENT_MAX_DISPLAYED = 3;

	/**
	 * probability for a map generator to create a random new Field or a copy of
	 * a neighbouring field. ([1, 0] - always random; [0, 1] - always copy;
	 * [<=0, <=0] create a black hole and destroy the entire universe)
	 */
